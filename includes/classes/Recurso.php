<?php
  ...
  Class Recurso {
    ...
    public function set_quantidade($quantidade): self { $this->quantidade = $quantidade; return $this; }
    ...
    public function edit(){
      ...
      if ( !$data )
        throw new NotFoundException("Recurso id: {$id} não encontrado, impossível editar o registro");
    ...
    public function delete($id){
      ...
      if ( !$data )
        throw new NotFoundException("Recurso id: {$id} não encontrado, impossível excluir o registro");
    ...
    public static function get_list_options(){
      $Recurso = new Recurso();
      $list = $Recurso->list(["ORDER" => "name asc"]);
    ...
    public function to_datatable($list){
      $return = [];
      $columns = ["Nome", "Status", "Tipo", "Quantidade", "Validade <small>meses</small>", "Ações"];
      $items = [];
      ...
      foreach ( $list as $key => $data ){
        ...
        $temp = [     
          ...
          [
            "text" => $data['tipo'], "classes" => ["text-center"],
            "attributes" => [ "order" => $data['tipo'], "raw" => $data['tipo'],],
            //"format" => "date_br",
          ],
          [
          ...
          [
            "text" => $data['quantidade'], "classes" => ["text-end"],
            "attributes" => [ "order" => $data['quantidade'], "raw" => $data['quantidade'],],
            //"format" => "number_br",
          ],
          /*
          */
      ...
      $form = [
        ...
        "fields" => [
          ...
          ['id' => 'nome',  'label' => 'Nome', 'required' => true,
            'type' => 'text', 'attributes' => ['minlength' => 1, 'maxlength' => 200, "placeholder" => "Informe o Nome/Código do recurso"]],  
          ...
          ['id' => 'tipo','label' => 'Tipo', 'required' => true,
            ...
            'options' => self::get_list_options_tipo()
          ],       
          
          ['id' => 'quantidade',  'label' => 'Quantidade', 'classes' => ['text-end'],
            'type' => 'number', 'attributes' => ['minlength' => 1, 'step' => ".01", "placeholder" => "Informe a quantidade"]],     
        ...
        switch ( $action ){
          case  "edit":
            $buttons[] = [ 
              ...
              "attributes" => [
                ...
                "data-bs-target" => "#modal_form_recurso",      
                "data-form_id" => "recurso",                                
              ],
              "href" => "#",
              //"required_permission" => "recurso_edit",
            ];
            break;
          ...
          case  "delete":
            $buttons[] = [ 
              ...
              "href" => "#",
              //"required_permission" => "recurso_delete",
            ];
            break;
        }
      }
