<?php
  ...
  Class RecursosContrato {
    ...
    private $table_name = "recursos_contrato";
    ...
    public function get_id_recurso(){ return $this->id_recurso; }
    public function set_id_recurso($id_recurso): self { $this->id_recurso = $id_recurso; return $this; }
    ...
    public function list_details($filters = []){
      ...
      $sql = "SELECT 
              ...
              inner join contrato on
                contrato.id = recursos_contrato.id_contrato

              inner join recurso on
                recurso.id = recursos_contrato.id_recurso
    ...
    public static function get_list_options_recurso(){
      $Recurso = new Recurso();
      $list = $Recurso->list(["ORDER" => "nome asc"]);
    ...
    public function to_datatable($list){
      $return = [];
      $columns = ["Contrato", "Recurso", "Tipo", "Validade <small>meses</small>", "Ações"];
      $items = [];
      ...
      foreach ( $list as $key => $data ){
        ...
        $temp = [     
          ...
          [
            "text" => $data['nome_recurso'], "classes" => ["text-left"],
            "attributes" => [ "order" => $data['nome_recurso'], "raw" => $data['nome_recurso'],]
          ],
          [
            "text" => $data['tipo_recurso'], "classes" => ["text-center"],
            "attributes" => [ "order" => $data['tipo_recurso'], "raw" => $data['tipo_recurso'],],
            //"format" => "date_br",
          ],
          [
          ...
          case  "edit":
            $buttons[] = [ 
              ...
              "attributes" => [
                ...
                "data-form_id" => "recursos_contrato",                                
              ],
              "href" => "#",
